# pylint: disable=not-callable, multiple-statements, fixme, line-too-long
# This module is partially taken from the RepVGG repo, credit to https://github.com/DingXiaoH/RepVGG
# --------------------------------------------------------
